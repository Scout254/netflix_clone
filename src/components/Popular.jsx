...
const Popular = () => {
    const [{popular,details},dispatch] = useStateValue();
  ...
  return (
    ...
    <h1 className="text-2xl font-bold mb-8">Popular Movies</h1>
    <Swiper
      slidesPerView={3}
      spaceBetween={30}
      // scrollbar={{ hide: true }}
      className="mySwiper"
    >
      {popular?.map(({ id, title, original_title, backdrop_path, poster_path, overview, vote_average, video, release_date }) => (
