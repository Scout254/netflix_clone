...
const Trending = () => {
    const [{trending,details},dispatch] = useStateValue();
  ...
  return (
    ...
    <h1 className="text-2xl font-bold mb-8">Trending Movies</h1>
    <Swiper
      slidesPerView={3}
      spaceBetween={30}
      // scrollbar={{ hide: true }}
      className="mySwiper"
    >
      {trending?.map(({ id, title, original_title, backdrop_path, poster_path, overview, vote_average, video, release_date }) => (
